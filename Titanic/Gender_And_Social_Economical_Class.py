...
def complex_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        ...
        #died
            ...
            predictions[passenger_id] = 0
    #return predictions
    survival= sum(df['Survived'])
    estimated_survival= sum(predictions.values())
    print 'Actual survival', survival
    print 'Estimated survival', estimated_survival
    print estimated_survival/survival
    

file = 'titanic_data.csv'
complex_heuristic(file)
